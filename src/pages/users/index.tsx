      ...
      render: (_, record) => (
        <div className="flex flex-col">
          <span className="leading-4">
            {dateTimeFormatter(record.created_at, "MM-DD-YYYY HH:MM:ss")}
          </span>
          <span className="leading-4">
            {dateTimeFormatter(record.updated_at, "MM-DD-YYYY HH:MM:ss")}
          </span>
        </div>
      ),
    },
  ...
  const renderAddUsers = (type: "ADD" | "EDIT", record?: TUserItem) => {
    ...
    return (
      <ModalForm
        ...
        trigger={
          isEdit ? (
            <Typography.Link onClick={() => setUploadedImg(record?.image!)}>
              Edit
            </Typography.Link>
          ) : (
                ...
                <ProFormUploadButton
                  ...
                  fieldProps={{
                    ...
                    fileList: uploadedImg
                      ? ([{ url: uploadedImg }] as UploadFile<any>[])
                      : [],
